---
name: shadcn-ui
description: "Shadcn/ui component integration guide for this project. Use when adding, customizing, or composing shadcn/ui components. Trigger on: installing a new component (\"add a Dialog\", \"I need a DataTable\"), customizing component variants or styles, choosing between shadcn components for a UI task, fixing shadcn component behavior or accessibility, setting up shadcn in a new project, or any mention of component names like Button, Sheet, Command, Combobox, Form, Toast, etc. Do NOT use for general Tailwind styling (use tailwind-best-practices) or design token decisions (use design-system)."
---
